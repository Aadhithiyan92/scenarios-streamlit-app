...
tab1, tab2, tab3 = st.tabs(["U.S. Map View", "State Comparison", "Scenario Analysis"])
...
st.markdown("---")
st.caption("Nationwide ZEV Adoption Modeling Dashboard | Data is simulated for demonstration purposes")